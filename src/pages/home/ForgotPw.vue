  ...
  <div class="page-header align-items-start min-vh-100">
    <div class="container my-auto">
      <v-card class="mx-auto opacity-background fadeIn1 fadeInBottom" max-width="400">
        <h4 class="text-red">HI ROBERT FORGOT PASS IS NOT WORKING PLEASE USE THE BUTTON TO SKIP TO DASHBOARD</h4>
        <v-btn color="orange"  href="/app" class="text-white mb-2"> SKIP TO DASHBOARD</v-btn>
